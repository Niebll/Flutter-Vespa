...
class _DetailVespaGTS extends State<DetailVespaGTS> {
  ...
  Future read() async {
    checkExist = await VespaDatabase.instance.read(widget.vespas.gts[widget.index].name.toString());
    setState(() {});
  }
  ...
  Future addData() async {
    var list;
    list = VespaCart(
        title: widget.vespas.gts[widget.index].name.toString(),
        imgthumbnail: widget.vespas.gts[widget.index].imgthumbnail.toString(),
        harga: widget.vespas.gts[widget.index].harga.toString(),
        primaryColor: widget.vespas.gts[widget.index].primarycolor.toString()
    );
  ...
  Future deleteData() async {
    await VespaDatabase.instance.delete(widget.vespas.gts[widget.index].name.toString());
    setState(() {
      checkExist = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
          backgroundColor: HexColor(widget.vespas.gts[widget.index].primarycolor.toString()),
          body: Stack(children: [
            SlidingUpPanel(
              ...
              body: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Spacer(),
                          Text(widget.vespas.gts[widget.index].tipe,
                    ...
                    Container(
                      color: HexColor(widget.vespas.gts[widget.index].primarycolor.toString()),
                      child: Center(
              ...
              panelBuilder: (controller) => PanelWidgetVespas(
                  ...
                  all: widget.vespas.gts[widget.index]
              ),
            ),
            Positioned(
                bottom: 0,
