...
class DetailVespaLimited extends StatefulWidget {
  DetailVespaLimited({Key? key, required this.vespas, required this.index})
      : super(key: key);
  Vespas vespas;
  int index;

  @override
  State<DetailVespaLimited> createState() => _DetailVespaLimited();
}
...
class _DetailVespaLimited extends State<DetailVespaLimited> {
  ...
  Future addData() async {
    ...
    list = VespaCart(
        ...
        harga: widget.vespas.limited[widget.index].harga.toString(),
        primaryColor: widget.vespas.limited[widget.index].primarycolor.toString()
    );
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
          backgroundColor: HexColor(widget.vespas.limited[widget.index].primarycolor.toString()),
          body: Stack(children: [
            SlidingUpPanel(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Spacer(),
                          Text(widget.vespas.limited[widget.index].tipe,
              ...
              panelBuilder: (controller) => PanelWidgetVespas(
                  ...
                  all: widget.vespas.limited[widget.index]
              ),
            ),
            Positioned(
                bottom: 0,
                        ...
                        Navigator.pushReplacement(
                            ...
                            MaterialPageRoute(
                              builder: (context) => PaymentPage(
                                  harga: widget.vespas.limited[widget.index].harga),
                            ));
                      },
                      child: Container(
                        width: 260,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              NumberFormat.simpleCurrency(locale: "EUR", decimalDigits: 0).format(widget.vespas.limited[widget.index].harga),
                              style: TextStyle(
