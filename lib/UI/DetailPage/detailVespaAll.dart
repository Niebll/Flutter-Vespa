...
class _DetailVespaAll extends State<DetailVespaAll> {
  ...
  Future read() async {
    checkExist = await VespaDatabase.instance.read(widget.vespas.all[widget.index].name.toString());
    setState(() {});
  }
  ...
  Future addData() async {
    var list;
    list = VespaCart(
        title: widget.vespas.all[widget.index].name.toString(),
        imgthumbnail: widget.vespas.all[widget.index].imgthumbnail.toString(),
        harga: widget.vespas.all[widget.index].harga.toString(),
        primaryColor: widget.vespas.all[widget.index].primarycolor.toString()
    );
  ...
  Future deleteData() async {
    await VespaDatabase.instance.delete(widget.vespas.all[widget.index].name.toString());
    setState(() {
      checkExist = false;
    });
  }
...
class PanelWidgetVespas extends StatelessWidget {
  ...
  const PanelWidgetVespas(
      {Key? key, required this.controller, required this.all})
      : super(key: key);
